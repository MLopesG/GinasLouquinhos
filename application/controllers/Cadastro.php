...
class Cadastro extends CI_Controller {
	...
	public function salvar_atleta()
	{
			...
			$this->form_validation->set_rules('cpf_atleta','CPF','required');
			...
			$this->form_validation->set_rules('cpf_responsavel','CPF responsável','required');
			...
			$this->form_validation->set_rules('data_cadastro','Dias de participação','required');
