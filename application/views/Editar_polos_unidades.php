...
<body>
	...
	<main>
		<div class="container">
			...
			<form action="<?=base_url("unidades/editar/salvar/".$unidade[0]->id_polo_unidade."") ?>" method='post'>
				<div class="container-input">
					<label for="polo_unidade">Nome unidade:</label>
					<input type="text" name="polo_unidade" id="polo_unidade" value="<?=$unidade[0]->polo_unidade?>"/>
				</div>
				<div class="container-input">
					<input type="submit" value="Alterar unidade - polo" >
				</div>
			</form>
		</div>
	</main>
